...
# Docker & Docker Compose are pre-installed on this machine
...
turn:
    enabled: true
    domain: livekit-turn.volantislive.com
    tls_port: 5349
    udp_port: 3478
    external_tls: true
keys:
    APIY7KcSayArEyo: zewvscS0R9ieMngmHjf1ZuwHcmJeznzNeiC1wb556msA

webhook:
    urls:
        - https://api.volantislive.com/webhook
    api_key: APIY7KcSayArEyo
...
apps:
  tls:
    certificates:
      automate:
        - livekit-server.volantislive.com
        - livekit-turn.volantislive.com
  layer4:
    servers:
      main:
        listen: [":443"]
